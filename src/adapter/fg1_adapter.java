...
public class fg1_adapter extends BaseExpandableListAdapter {
	    ...
	    public ArrayList<String> groupList=new ArrayList<String>();
	 	...
	 	public fg1_adapter(Context context, ArrayList<String> groupList,ArrayList<ArrayList<Array>> childlist ){
		...
		public View getGroupView(int groupPosition, boolean isExpanded,
			...
			View view=View.inflate(context, R.layout.parent1, null);
			
		    parent_text=(TextView) view.findViewById(R.id.parent_text);
			parent_image=(ImageView) view.findViewById(R.id.parent_image);
			if(groupPosition!=0){
				parent_image.setVisibility(View.GONE);
			...
			parent_text.setText(groupList.get(groupPosition));
			return view;
		}
		...
		public View getChildView(int groupPosition, int childPosition,
			...
			holder.child_period.setText(String.valueOf(childlist.get(groupPosition).get(childPosition).period)+"天");
